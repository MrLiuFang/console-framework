		...
		<div class="layui-card">
			...
			<div class="layui-card-body">
				<form class="layui-form " action="${ctx}/admin/menu/add"
					...
					<div class="layui-form-item  qc-select-group">
						...
						<div class="layui-input-inline">
							<pepper:Enum2Select required="true" documentId="scope"
								...
								documentName="scope" selectedValue="1" />
						</div>
						<c:choose>
					...
					<div class="layui-form-item ">
						...
						<div class="layui-input-inline">
							<input type="text" name="name" id="name" lay-verify="required"
								maxlength="100" autocomplete="off" placeholder="菜单名称"
								class="layui-input">
						</div>
					</div>
					<div class="layui-form-item ">
					...
					<div
						class="layui-form-item <c:choose><c:when test="${menuType eq 0}">layui-hide</c:when></c:choose>"
						id="add-url-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<pepper:Enum2Select required="true" documentId="status"
								...
								documentName="status" selectedValue="0" />
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-inline" style="text-align: center;">
						...
						<pepper:auth code="SYSTEM_SETTINGS_MENU_ADD">
...
<script type="text/javascript">
	$(function() {
		...
		initRootMenuOption("1");
		initChildMenuOption("${rootMenu.id}");
		layui.form.render('select');
	});
</script>