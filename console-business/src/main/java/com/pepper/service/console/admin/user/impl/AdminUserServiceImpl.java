...
//		pager = adminUserDao.list(pager, pager.getJpqlParameter().getSearchParameter(), pager.getJpqlParameter().getSortParameter());
	...
	public Pager<AdminUser> findAdminUser(Pager<AdminUser> pager,String account,String mobile,String email,String name,String departmentId,String departmentGroupId,String roleId,Boolean isWork,Status status,String roleCode,String keyWord){
		return adminUserDao.findAdminUser(pager,account, mobile, email, name, departmentId, departmentGroupId, roleId,isWork, status,roleCode, keyWord);
	}
	...
	@Override
	public List<AdminUser> findByDepartmentIdAndIsManagerAndDepartmentGroupIdIsNullOrDepartmentGroupId(
			String departmentId, Boolean isManager) {
		return adminUserDao.findByDepartmentIdAndIsManagerAndDepartmentGroupIdIsNullOrDepartmentGroupId(departmentId, isManager, "");
	}
