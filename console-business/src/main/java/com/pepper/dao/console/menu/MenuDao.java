...
public interface MenuDao extends BaseDao<Menu> {
	...
	List<Menu> queryRoleChildMenu(String parentMenuId, String roleId, Integer statusOrdinal);
	...
	List<Menu> queryRoleRootMenuByRoleId(String roleId, Integer statusOrdinal);
